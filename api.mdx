...
The Indexy API is currently in **closed beta**. To request access, please contact our team at [Discord](https://discord.gg/QJqmgGeCTb). Once approved, you'll receive an API key for testing.
