---
title: "API"
description: "Documentation for Indexy's API"
---
...
The Indexy API is currently in **closed beta**. To request access, please contact our team at [Discord](https://discord.gg/QJqmgGeCTb) or in this [form](https://indexy.xyz/api/). Once approved, you'll receive an API key for testing.
