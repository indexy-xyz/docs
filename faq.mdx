...
To track an index, click the **"Track"** button next to it. It will appear in your **Tracklist**, where you can monitor its performance, view the underlying tokens, and access detailed analytics over time.

---

### **Can I buy or sell indexes?**

Buying and selling indexes is currently in Closed Beta. You can request access by trying to buy an index in the app.
