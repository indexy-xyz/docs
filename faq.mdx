...
Yes! Join our Discord at [https://discord.gg/indexy](https://discord.gg/indexy) to connect with others and stay updated.
...
Yes! You can request access to our API Beta at [https://indexy.xyz/api](https://indexy.xyz/api).
